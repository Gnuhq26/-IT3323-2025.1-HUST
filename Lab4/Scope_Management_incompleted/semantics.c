...
Object *checkDeclaredLValueIdent(char *name)
{
  ...
  // Variable và Parameter luôn là lvalue hợp lệ
  if (obj->kind == OBJ_VARIABLE || obj->kind == OBJ_PARAMETER)
    return obj;

  // Function chỉ hợp lệ nếu là function hiện tại (để gán return value)
  ...
  // Các trường hợp khác (CONST, TYPE, PROCEDURE) không phải lvalue
